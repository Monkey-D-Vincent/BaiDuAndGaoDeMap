...
public class NumberUtils {
     ...
     * 单位
     */
    private static String[] CN_UNITS = new String[]{"个", "十", "百", "千", "万", "十", "百", "千", "亿", "十", "百", "千", "万"};

    /**
     * 汉字
     */
    private static String[] CN_CHARS = new String[]{"零", "一", "二", "三", "四", "五", "六", "七", "八", "九"};
     ...
     * @return
     */
    private static String cvt(long num, boolean isColloquial) {
